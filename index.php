...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <!-- <h1><a href="index.html">DUP</a></h1> -->
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="index.html"><img src="assets/img/DUP-PNG1.png" alt="" class="img-fluid"></a>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/img/DUP-logo.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p>
              At DUP Group Pvt Ltd, we pride ourselves on seamlessly integrating a spectrum of services to craft an all-encompassing lifestyle experience. Nestled at the core of our offerings is a sumptuous hotel that embodies comfort and hospitality, ensuring an extraordinary stay for both leisure and business travelers.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i><h4>Lifestyle Integration:</h4> 
                Seamlessly blend luxury hospitality, captivating landscapes, curated retail, and premier car sales for a holistic lifestyle experience</li>
              <li><i class="ri-check-double-line"></i><h4>Expertise Across Divisions:</h4>From transforming spaces into enchanting landscapes to offering high-quality products and diverse vehicles, each division brings specialized excellence.</li>
              <li><i class="ri-check-double-line"></i><h4>Dedicated to Excellence:</h4>United in commitment, we prioritize outstanding service, continuous innovation, and unwavering excellence to enhance your quality of life.</li>
              
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <p>
              Our Landscape Design division is dedicated to transforming spaces into enchanting environments, harmonizing nature and aesthetics to forge visually striking and functional landscapes. Meanwhile, our Retail Business meticulously curates a diverse array of high-quality products, presenting an unmatched shopping experience
            </p>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="info">
              <div>
                ...
                <p>No:170 Abhayaraja Mawatha<br>Kadirandola,Matugama</p>
              </div>
